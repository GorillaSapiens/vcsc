...
# player_color_181_unofficial hostile poison diagnostic band below
...
Build with `make`. The result is `player_color_181_unofficial_poison_score_below_interactive.bin`.
