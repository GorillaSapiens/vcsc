...
| [`04_renderers/player_color_unofficial`](04_renderers/player_color_unofficial/) | Stable/common-NMOS unofficial-opcode player-color renderer peer | Matching ten-layout score/poison matrix |
...
| [`04_renderers/faithful_legacy_multisprite`](04_renderers/faithful_legacy_multisprite/) | Faithful unbanked/non-Superchip legacy multisprite baseline with integrated score/playfield and retained unofficial opcodes | Fixed P0 + five multiplexed-P1 raster, asymmetric playfield, and six-digit score diagnostic |
...
| [`04_renderers/player_color/score_above_and_below`](04_renderers/player_color/score_above_and_below/) | Official parameterized player-color renderer at `lines:=170` | Interactive score-above + P0/P1/Ball gameplay + score-below composition |
...
exception is `04_renderers/player_color/animated_sprites/`, whose original artwork
