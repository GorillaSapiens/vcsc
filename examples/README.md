...
| [`16_all_five_player_color_181`](16_all_five_player_color_181/) | Official-opcode 181-line P0/P1/M0/M1/Ball renderer with independent eight-row P0/P1 color tables | Fixed centered score above and below combined gameplay |
...
profile adds two focused fixed-score compositions. Across all renderer and
architecture groups, the public tree contains **65 editable cartridges**.
