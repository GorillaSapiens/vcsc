...
the 228-line visible boundary; it is intentionally not a naive 18 + 192 + 18 split. The source feeds the same background, playfield, P0, and P1 RGB intents used by
