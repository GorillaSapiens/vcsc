...
# Static three-plus-three score-below diagnostic

This cartridge composes the 181-line `all_five_player_color_181` renderer
with `three_plus_three_score_component.c26` below the gameplay field. The
...
Build with `make`. The result is `all_five_player_color_181_three_plus_three_score_below.bin`.
