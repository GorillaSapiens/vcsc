...
# all_five_181_unofficial right-justified six-digit score below
...
Build with `make`. The result is `all_five_181_unofficial_right_justified_score_below_interactive.bin`.
