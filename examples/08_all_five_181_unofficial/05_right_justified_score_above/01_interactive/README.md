...
# all_five_181_unofficial right-justified six-digit score above
...
Build with `make`. The result is `all_five_181_unofficial_right_justified_score_above_interactive.bin`.
