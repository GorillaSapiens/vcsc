...
# all_five_181_unofficial left-justified six-digit score below
...
Build with `make`. The result is `all_five_181_unofficial_left_justified_score_below_interactive.bin`.
