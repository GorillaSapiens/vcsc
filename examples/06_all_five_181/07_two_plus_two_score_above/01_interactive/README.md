...
# all_five_181 independently positioned left/right two-plus-two score above
...
Build with `make`. The result is `all_five_181_two_plus_two_score_above_interactive.bin`.
