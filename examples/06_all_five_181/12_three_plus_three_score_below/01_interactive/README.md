...
# Interactive three-plus-three score-below diagnostic

The score is drawn **below** the 181-line all-five gameplay field. SELECT cycles
through P0, P1, M0, M1, and Ball; the left joystick moves the selected object.

The right joystick acts immediately once per direction press; holding it does not
repeat, and it must return fully to neutral before another press. Left/right
selects one of the six visible score digits. Up/down
