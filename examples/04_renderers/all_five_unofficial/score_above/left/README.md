...
# all_five_181_unofficial left-justified six-digit score above
...
Build with `make`. The result is `all_five_181_unofficial_left_justified_score_above_interactive.bin`.
