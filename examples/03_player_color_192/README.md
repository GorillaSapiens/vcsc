...
| 02 | [`animated_sprites`](02_animated_sprites/) | Move all 30 four-frame source animations from the left edge to the right in 15 pairs, switching pairs on each wrap |
