...
| 02 | [`animated_sprites`](02_animated_sprites/) | Move four pairs of four-frame 8x8 sprite adaptations from the left edge to the right, switching pairs on each wrap |
