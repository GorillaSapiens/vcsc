...
#define O26_RTYPE_BANK_TARGET_MASK (O26_RTYPE_INDIRECT_JMP | O26_RTYPE_CONTROL_MASK)
#define O26_RTYPE_IS_BANK_TARGET(type) (((type) & O26_RTYPE_BANK_TARGET_MASK) == O26_RTYPE_BANK_TARGET)
