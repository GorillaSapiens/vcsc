...
diagnostic metadata, including branches to assembler-local labels.  Linker maps
...
NMOS 6502/6507 extra-cycle rule.  This metadata does not affect placement yet;
branch-aware placement is a separate later step.
