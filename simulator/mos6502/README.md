...
so expect nearly 100% compliance with the real deal... at least on the normal behavior: as I said stuff like illegal opcodes or hardware glitches are not implemented.
...
You can use this emulator in your machine emulator project. Cycle accuracy is not implemented, so mid-frame register update tricks cannot be reliably emulated.
...
Illegal opcodes are not supported; the emulator executes a simple NOP for them.
