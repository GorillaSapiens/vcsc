...
my $source=File::Spec->catfile($repo,'examples','07_diagnostics/bankswitching','0840','econobanking_diagnostic.c26');
my $example_dir=File::Spec->catdir($repo,'examples','07_diagnostics/bankswitching','0840');
