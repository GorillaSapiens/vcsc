...
constexpr uint8_t kFont[10][8] = {
   {0x3e,0x63,0x67,0x67,0x73,0x73,0x63,0x3e},
   {0x04,0x1c,0x3c,0x1c,0x1c,0x1c,0x1c,0x7f},
   {0x3e,0x43,0x03,0x03,0x3e,0x60,0x60,0x7f},
   {0x3e,0x43,0x03,0x1e,0x03,0x03,0x43,0x3e},
   {0x06,0x1e,0x26,0x46,0x46,0x7f,0x06,0x06},
   {0x7f,0x60,0x60,0x3e,0x03,0x03,0x43,0x3e},
   {0x3e,0x61,0x60,0x7e,0x63,0x63,0x63,0x3e},
   {0x3f,0x41,0x03,0x06,0x1c,0x30,0x30,0x30},
   {0x3e,0x63,0x63,0x3e,0x63,0x63,0x63,0x3e},
   {0x3e,0x63,0x63,0x63,0x3f,0x03,0x43,0x3e}
};

[[noreturn]] void fail_detail(const char *fmt, ...) {
   std::fprintf(stderr, "vcs_six_glyph_wide_raster: ");
   va_list ap;
   va_start(ap, fmt);
