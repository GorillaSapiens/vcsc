...
for my $entry (@examples) {
   ...
   push @extra,'-DVCSC_INLINE_BANKCALL=1' if $file eq 'jane_diagnostic.c26' || $file eq 'econobanking_diagnostic.c26' || $file eq 'ua_diagnostic.c26' || $file eq 'uasw_diagnostic.c26' || $file eq 'fotomania_diagnostic.c26' || $file eq 'fa_ram_plus_diagnostic.c26' || $file eq 'dpc_diagnostic.c26' || $file eq 'fa2_diagnostic.c26';
   ...
   if ($file eq 'bankswitching_diagnostic.c26' ||
      ...
      push @extra,'-DVCSC_INLINE_BANKCALL=1' if $file eq 'bankswitching_diagnostic.c26';
