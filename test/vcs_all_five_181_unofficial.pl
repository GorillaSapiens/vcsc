...
# phase: e2e
# timeout: 12
# expectstdout: vcs_all_five_181_unofficial ok: official=1858 unofficial=1858 delta=0
# expectexit: 0
...
$official_used==1858 or die "official smoke now uses $official_used bytes, expected 1858\n";
$unofficial_used==1858 or die "unofficial smoke now uses $unofficial_used bytes, expected 1858\n";
...
my @ram_symbols=qw(
   ...
   game_player0_color game_player1_color game_object_masks
);
