...
# phase: e2e
# timeout: 12
# expectstdout: vcs_all_five_181_unofficial ok: official=1879 unofficial=1879 delta=0
# expectexit: 0
...
$official_used==1879 or die "official smoke now uses $official_used bytes, expected 1879\n";
$unofficial_used==1879 or die "unofficial smoke now uses $unofficial_used bytes, expected 1879\n";
