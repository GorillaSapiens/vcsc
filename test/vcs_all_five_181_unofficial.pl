...
# phase: e2e
# expectstdout: vcs_all_five_181_unofficial ok: official=1479 unofficial=1479 delta=0
# expectexit: 0
...
$official_used==1479 or die "official smoke now uses $official_used bytes, expected 1479\n";
$unofficial_used==1479 or die "unofficial smoke now uses $unofficial_used bytes, expected 1479\n";
