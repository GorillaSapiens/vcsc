...
die "software-stack inventory total drift: got $total_push/$total_pop, expected 24/67\n"
    unless $total_push == 24 && $total_pop == 67;

print "software-stack inventory ok: 24 push sites, 67 pop emissions\n";
