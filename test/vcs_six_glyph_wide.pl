...
$map_text =~ /rom\s+used=1135 bytes/ or die "wide fixture ROM accounting changed\n";
...
$public_map_text =~ /rom\s+used=1207 bytes/ or die "public wide example ROM accounting changed\n";
