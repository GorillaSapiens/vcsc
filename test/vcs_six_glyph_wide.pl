...
$map_text =~ /rom\s+used=918 bytes/ or die "wide fixture ROM accounting changed\n";
...
$public_map_text =~ /rom\s+used=1060 bytes/ or die "public wide example ROM accounting changed\n";
