...
for my $parts (
   ...
   [qw(libraries vcs vcs_24k_fa2.c26)],
   [qw(libraries vcs vcs_28k_fa2.c26)],
   [qw(libraries vcs fa_ram_plus.c26)],
   [qw(libraries vcs vcs_16k_f6.c26)],
   [qw(libraries vcs vcs_16k_jane.c26)],
   ...
   [qw(libraries vcs vcs_omni_32k.c26)],
   [qw(libraries vcs vcs_omni_32k.cfg)],
   [qw(libraries vcs vcs_4k.cfg)],
   [qw(libraries vcs vcs_8k_f8.cfg)],
   [qw(libraries vcs vcs_12k_fa.cfg)],
   [qw(libraries vcs vcs_24k_fa2.cfg)],
   [qw(libraries vcs vcs_28k_fa2.cfg)],
   [qw(libraries vcs vcs_16k_f6.cfg)],
   [qw(libraries vcs vcs_16k_jane.cfg)],
