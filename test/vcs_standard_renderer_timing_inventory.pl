...
# phase: e2e
# expectstdout: vcs_standard_renderer_timing_inventory ok
# expectexit: 0
...
my $dir=File::Spec->catdir($repo,'libraries','vcs','renderers','standard_4k_ntsc');
...
print "vcs_standard_renderer_timing_inventory ok\n";
