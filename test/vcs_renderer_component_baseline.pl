...
require_re($doc,qr/official linked ROM bytes:\s+1795.*unofficial linked ROM bytes:\s+1795.*signed byte difference:\s+0/s,
...
require_re($unofficial,qr/official linked ROM bytes:\s+1795.*unofficial linked ROM bytes:\s+1795.*signed byte difference:\s+0/s,
