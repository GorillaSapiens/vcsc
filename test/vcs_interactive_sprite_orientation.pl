...
my @definitions=(
   ...
   [qw(examples 07_player_color_181_unofficial 01_score_above 01_interactive player_color_181_unofficial_score_above_interactive.c26)],
   [qw(examples 07_player_color_181_unofficial 02_score_below 01_interactive player_color_181_unofficial_score_below_interactive.c26)],
   [qw(examples 08_all_five_181_unofficial 01_score_above 01_interactive all_five_181_unofficial_score_above_interactive.c26)],
   [qw(examples 08_all_five_181_unofficial 02_score_below 01_interactive all_five_181_unofficial_score_below_interactive.c26)],
...
@leaves==43 or die "found ".scalar(@leaves)." interactive sources, expected 43\n";
for my $path (@leaves) {
