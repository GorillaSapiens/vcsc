...
# phase: e2e
# expectstdout: vcs_standard_renderer_unofficial_opcodes ok
# expectexit: 0
...
my $dir=File::Spec->catdir($repo,qw(libraries vcs renderers standard_4k_ntsc));
...
my $cycle_src=File::Spec->catfile($repo,'test','vcs_standard_renderer_unofficial_cycles.cpp');
...
$out eq "vcs_standard_renderer_unofficial_cycles ok\n" or die "unexpected cycle output: $out";
...
print "vcs_standard_renderer_unofficial_opcodes ok\n";
