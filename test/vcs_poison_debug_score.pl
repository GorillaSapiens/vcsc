...
my $component=File::Spec->catfile($vcs,qw(kernels poison_debug_score poison_debug_score.c26));
...
$text =~ /TEMPLATE_MODULE_RAM_BYTES\s*:=\s*0/ or die "poison component is not zero-RAM\n";
...
for my $required (qw(04 05 0B 0C 0D 0E 0F 10 11 12 13 14 1B 1C 1D 1E 1F 20 21 22 23 24 25 26 27 2A)) {
...
$map !~ /\bpoison_(?:score|pointers|row|delayed|workspace)\b/
   or die "poison component unexpectedly allocated instance RAM\n";
