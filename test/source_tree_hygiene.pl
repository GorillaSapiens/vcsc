...
index($bankswitching,'0FA0 is 69/80 (`$050`)')>=0 &&
...
index(slurp(File::Spec->catfile($repo,qw(libraries vcs F8 inline_bankcall.s26))),'__vcsc_generic_bankcall_reserved_end = $6050')>=0 &&
...
index($top_make,'libraries/vcs/0FA0/inline_bankcall.s26')>=0
   or die "DPC/FA2/JANE/0840/UA/UASW/0FA0 diagnostics lost inline-target bank-call opt-in or template packaging\n";
...
for my $legacy (qw(
   inline_bankcall.s26 superchip.c26 fa_ram_plus.c26 commavid.c26 dpc.c26
