...
-f File::Spec->catfile($repo,'libraries','vcs','vcs_8k_e0.c26') &&
-f File::Spec->catfile($repo,'libraries','vcs','vcs_8k_e0.cfg') &&
index($top_make,'libraries/vcs/vcs_8k_e0.c26')>=0 &&
index($top_make,'libraries/vcs/vcs_8k_e0.cfg')>=0 &&
