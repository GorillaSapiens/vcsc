...
my $source=File::Spec->catfile($repo,'examples','07_diagnostics/bankswitching','f864','bankswitching_diagnostic.c26');
my $source_text=read_file($source);
my $status_font=read_file(File::Spec->catfile($repo,'examples','07_diagnostics/bankswitching','f864','status_font.c26'));
my $cart_type_font=read_file(File::Spec->catfile($repo,'examples','07_diagnostics/bankswitching','f864','cart_type_font.c26'));
