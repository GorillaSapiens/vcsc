...
my $cfg=File::Spec->catfile($vcs,'vcs_2k_cv.cfg');
my $profile=File::Spec->catfile($vcs,'vcs_2k_cv.c26');
my $device=File::Spec->catfile($vcs,'commavid.c26');
