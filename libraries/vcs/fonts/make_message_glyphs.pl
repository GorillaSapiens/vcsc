...
my $license;
GetOptions('license=s' => \$license) or usage();

# Usage:
#   ./make_message_glyphs.pl [--license PATH] FONTFILE "MESSAGE"
#
...
print "// Generated by libraries/vcs/fonts/make_message_glyphs.pl; do not edit.\n";
print "// This file is covered under CC0-1.0. See $license.\n" if defined $license;
...
sub usage {
    die <<'USAGE';
usage: make_message_glyphs.pl [--license PATH] FONTFILE "MESSAGE"

Pack MESSAGE into exactly six 8-bit glyph cells. --license emits a CC0 notice
for generated files outside libraries/vcs/fonts/.
USAGE
}
