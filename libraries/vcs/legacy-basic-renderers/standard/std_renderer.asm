...
.continueP0
     ...
     ifnconst no_blank_lines
         ...
         ifconst readpaddle
             ...
             bpl noreadpaddle
             inc paddle
             jmp continuerenderer2
noreadpaddle
             sleep 2
             jmp continuerenderer
         else
             ifnconst playercolors 
                 ifconst PFcolors
                     txa
...
noshakescreen2
     ...
     lda temp2 ;restore variables that were obliterated by renderer
     sta player0y
     lda temp3
     sta player1y
     ifnconst player1colors
