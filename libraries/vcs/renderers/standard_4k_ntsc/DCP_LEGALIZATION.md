...
# Standard-renderer DCP legalization

The normalized two-line renderer originally retained eleven zero-page `DCP`
...
live BL, M1, and M0 update. The visible renderer consumes the bits with legal
...
* a 37-cycle pre-renderer setup call crossed a scanline, and its replacement delay
