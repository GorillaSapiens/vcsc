...
| ---: | ---: | --- | ---: |
| 192 | 48 bytes / 12 rows | full-height, scoreless | 23 bytes |
...
192-line profile positions P0, P1 and Ball during VBLANK and enters the raster
...
The 192-line profile additionally supports mutable player-color tables for the
