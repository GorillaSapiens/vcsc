...
- `renderers/all_five/` ... consolidated parameterized official-opcode gameplay selector; defaults to P0/P1/M0/M1/BL solid colors, while `missiles:=0, player_colors:=1` selects the P0/P1/BL per-row-color profile; both support 228/192/181/170 visible-line schedules
