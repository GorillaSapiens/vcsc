...
- `renderers/COMPONENT_CONVERSION.md` ... measured predecessor baseline, machine-readable visible-component handoff/TIA ownership table, and the explicit 181-line score-composable and 192-line scoreless profile contracts
...
- `renderers/standard_4k_ntsc/` and `renderers/standard_4k_ntsc_playercolors/` are maintained standalone compatibility profiles. They were originally derived from upstream BASIC, but their C26/S26 sources are now authoritative and no imported upstream renderer tree is required.
