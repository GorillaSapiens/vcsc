...
- `renderers/COMPONENT_CONVERSION.md` ... renderer/component lifecycle history, machine-readable visible-component handoff/TIA ownership table, and the explicit score-composable/full-height profile contracts
...
- `renderers/all_five/` ... consolidated parameterized official-opcode gameplay selector; defaults to P0/P1/M0/M1/BL solid colors; `missiles:=0, player_colors:=1` selects the P0/P1/BL per-row-color profile; `missiles:=1, player_colors:=1` selects the combined all-five row-color profile at 181 or 192 lines; the first two support 228/192/181/170 visible-line schedules
