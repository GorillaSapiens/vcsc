...
# Unofficial-opcode 181-line player-color kernel
...
P0/P1/Ball API, per-row color contract, 181-line gameplay field, 13/52/65-byte
RAM layout, scanline schedule, score-composition behavior, and cleanup rules.

Assemble cartridges using this component with `-Wa,--illegals`. The component
uses only reviewed stable/common NMOS forms: two `AXS #252` operations and
