...
`test/fixtures/vcs_examples/05_static_kernel/golden.c26` is the retained complete integration: it links the
...
`test/fixtures/vcs_examples/05_static_kernel/golden.c26` produces a stable
...
`test/fixtures/vcs_examples/05_static_kernel` carries a checked Stella 7.0 PNG plus exact
