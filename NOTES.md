...
| Wide binary scalars       | The core and stock headers support ordinary signed/unsigned widths from one through four bytes. `bcd32_t` remains queued.                                                   | `context.txt`, `compiler/compile_type.c`, `compiler/compile_function.c`                        |
