...
| Wide binary scalars       | The core supports ordinary signed/unsigned widths from one through four bytes. Stock headers expose 8-, 16-, and 24-bit names; canonical 32-bit names and `bcd32_t` remain queued.                                                   | `context.txt`, `compiler/compile_type.c`, `compiler/compile_function.c`                        |
